...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    "DiffText
    "ErrorMsg
    call <SID>X("VertSplit", "525252", "", "NONE")
    ...
    call <SID>X("NonText", "525252", "", "")
    call <SID>X("SpecialKey", "525252", "", "NONE")
    "call <SID>X("Question", "00ff7f", "", "")
    call <SID>X("Search", "929292", "333333", "NONE")
